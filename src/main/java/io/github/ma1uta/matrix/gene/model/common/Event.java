...
public class Event {
    ...
    public static class EventType {
         ...
         * <td>aliases</td>
         * <td>[string]</td>
         * <td>Required. A list of room aliases</td>
         * </tr>
         * </table>
         */
         ...
         * <td>alias</td>
         * <td>string</td>
         * <td>Required. The canonical alias</td>
         * </tr>
         * </table>
         */
         ...
         * <td>creator</td>
         * <td>string</td>
         * <td>Required. The user_id of the room creator. This is set by the homeserver.</td>
         * </tr>
         * <tr>
         * <td>m.federate</td>
         * <td>boolean</td>
         * <td>Whether users on othe servers can join this room. Defaults to true if key does not exist.</td>
         * </tr>
         * </table>
         */
         ...
         * <td>join_rule</td>
         * <td>enum</td>
         * <td>Required. The type of rules used for users wishing to join this room. One of: ["public", "knock", "invite", "private"]</td>
         * </tr>
         * </table>
         */
         ...
         * <td>ban</td>
         * <td>number</td>
         * <td>The level required to ban a user. Defaults to 50 if unspecified.</td>
         * </tr>
         * <tr>
         * <td>events</td>
         * <td>{string: number}</td>
         * <td>The level required to send specific event types. This is a mapping from event type to power level required.</td>
         * </tr>
         * <tr>
         * <td>events_default</td>
         * <td>number</td>
         * <td>The default level required to send message events. Can be overridden by the events key. Defaults to 0 if unspecified.</td>
         * </tr>
         * <tr>
         * <td>invite</td>
         * <td>number</td>
         * <td>The level required to invite a user. Defaults to 50 if unspecified.</td>
         * </tr>
         * <tr>
         * <td>kick</td>
         * <td>number</td>
         * <td>The level required to kick a user. Defaults to 50 if unspecified.</td>
         * </tr>
         * <tr>
         * <td>redact</td>
         * <td>number</td>
         * <td>The level required to redact an event. Defaults to 50 if unspecified.</td>
         * </tr>
         * <tr>
         * <td>state_default</td>
         * <td>number</td>
         * <td>The default level required to send state events. Can be overridden by the events key. Defaults to 50 if unspecified,
         * but 0 if there is no m.room.power_levels event at all.</td>
         * </tr>
         * <tr>
         * <td>users</td>
         * <td>{string: number}</td>
         * <td>The power levels for specific users. This is a mapping from user_id to power level for that user.</td>
         * </tr>
         * <tr>
         * <td>users_default</td>
         * <td>number</td>
         * <td>The default power level for every user in the room, unless their user_id is mentioned in the users key.
         * Defaults to 0 if unspecified.</td>
         * </tr>
         * </table>
         */
         ...
         * <td>body</td>
         * <td>string</td>
         * <td>Required. The textual representation of this message.</td>
         * </tr>
         * <tr>
         * <td>msgtype</td>
         * <td>string</td>
         * <td>Required. The type of message, e.g. m.image, m.text</td>
         * </tr>
         * </table>
         */
         ...
         * <td>string</td>
         * <td>Required. The event that this feedback is related to.</td>
         * </tr>
         * <tr>
         * <td>type</td>
         * <td>enum</td>
         * <td>Required. The type of feedback. One of: ["delivered", "read"].</td>
         * </tr>
         * </table>
         * <br>
         ...
         * <td>name</td>
         * <td>string</td>
         * <td>Required. The name of the room. This MUST NOT exceed 255 bytes.</td>
         * </tr>
         * </table>
         */
         ...
         * <td>pinned</td>
         * <td>[string]</td>
         * <td>Required. An ordered list of event IDs to pin.</td>
         * </tr>
         * </table>
         */
         ...
         * </table>
         *
         * <p>Tags namespaces are defined in the following way, depending on how the client are expected to interpret them:</p>
         * <ul>
