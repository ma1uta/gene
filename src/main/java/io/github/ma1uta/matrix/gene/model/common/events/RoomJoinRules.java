 ...
 * Currently, ``knock`` and ``public`` are reserved keywords which are not implemented.
 */
public class RoomJoinRules implements EventContent {

    /**
     * The type of rules used for users wishing to join this room. One of: ["public", "knock", "invite", "public"]
     */
